...
from retriever.indices_dict import INDICES
from retriever.topics_dict import TOPICS
...
def main():
    for dataset in ['covid', 'robust04', 'touche', 'scifact', 'signal', 'news', 'dbpedia', 'nfc', 'nq', 'fiqa', 'hotpotqa']:
